    ...
    >
      <div className="max-w-6xl mx-auto flex items-center justify-between px-5 md:px-10 py-3 md:py-4">
        <a href="#hero" className="flex items-center gap-2 md:gap-3 group">
          ...
          <span className="font-display text-[10px] sm:text-xs md:text-sm tracking-[0.18em] sm:tracking-[0.25em] uppercase text-cream whitespace-nowrap">
            Marcus Aurelius
          </span>
        </a>
        ...
        <div className="flex items-center gap-2 md:gap-4">
          <button
            ...
            className="group flex items-center gap-2 font-display text-[10px] md:text-xs tracking-[0.2em] uppercase text-cream-dim hover:text-gold transition-colors px-2 py-2"
          >
          ...
          <a
            href="#contact"
            className="font-display text-[10px] md:text-xs tracking-[0.2em] uppercase border border-gold text-gold px-3 py-2 md:px-5 md:py-2.5 hover:bg-gold hover:text-ink transition-colors duration-500"
          >
